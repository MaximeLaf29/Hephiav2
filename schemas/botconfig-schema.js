...
const configBotSchema = mongoose.Schema({
  ...
  discordLoggerModule: {
    ...
    roleAdd: {
      ...
      defaultMessage: { type: String, default: "User {USER} has received the {ROLE} role." }
    },
    roleRemove: {
      discordLoggerModuleType,
      loggerRoleSpecialMessage,
      defaultMessage: { type: String, default: "User {USER} lost the {ROLE} role." }
    },
    ...
    join: {
      ...
      defaultMessage: { type: String, default: "{USER} just JOINED the server." }
    },
    leave: {
      discordLoggerModuleType,
      loggerJoinLeaveSpecialMessage,
      defaultMessage: { type: String, default: "{USER} just LEFT the server." }
    },
    // Moderation Logging
    ban: {
      loggerModerationType,
      defaultMessage: { type: String, default: "{USER} was BANNED from the server." }
    },
    unban: {
      loggerModerationType,
      defaultMessage: { type: String, default: "{USER} was UNBANNED from the server." }
    },
    kick: {
      loggerModerationType,
      defaultMessage: { type: String, default: "{USER} was KICKED from the server." }
    },
    timeout: {
      loggerModerationType,
      defaultMessage: { type: String, default: "{USER} was TIMED OUT for {TIME}." }
    },
