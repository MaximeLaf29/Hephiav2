...
const loggerRoleSpecialMessage = {
    messageState: falseBool,
    roleListForMessage: [
        {
            // array of role information
            roleId: emptyString,
            messageChannel: emptyString,
...
const ticketType = {
    customID: emptyString,
    ticketName: emptyString,
    isEnabled: trueBool,
    buttonText: emptyString,
    emoji: emptyString,
    buttonColor: emptyString,
    ticketNamingType: zeroNumber,
    ticketNamingScheme: emptyString,
    openingMessage: emptyString,
    pingRole: falseBool,
...
const configBotSchema = mongoose.Schema({
    ...
    discordLoggerModule: {
        ...
        // Message Logging
        messageRemove: discordLoggerModuleTypeMessage,
        ...
        // Channel Logging
        channelChange: discordLoggerModuleType,
        // [TODO] add channel edit, add, delete
        // Invite Link Detection Logging
        // add thread edit, add, delete
        inviteLink: { discordLoggerModuleType, inviteLinkStaff: falseBool },
    ...
    moderationCommands: falseBool,
    warningSystem: { type: [String], default: [] },
    rolePickingSystem: { type: [String], default: [] },
